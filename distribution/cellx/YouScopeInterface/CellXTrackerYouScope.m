classdef CellXTrackerYouScope < handle
...
%         nrOfFrames;
    ...
    methods
        ...
        function obj = CellXTrackerYouScope(config, currentFileSetData,currentFileSetegmentationMask,...
                                             nextFileSetData,nextFileSetSegmentationMask)
            obj.segmentationConfig   = config;
            obj.currentFileSetData = currentFileSetData;
            obj.nextFileSetData = nextFileSetData;
            obj.currentFileSetSegmentationMask = currentFileSetegmentationMask;
            obj.nextFileSetSegmentationMask = nextFileSetSegmentationMask;
        ...
        function run(this)
            ...
            fprintf('   Weighted Graph Matching progress: %d',0);n=1;
                    ...
                    this.currentFileSetNumber = 1;
                    this.nextFileSetNumber = 2;
